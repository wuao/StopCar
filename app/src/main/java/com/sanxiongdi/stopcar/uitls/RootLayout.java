...
//        }
        ...
        View titleBarView = LayoutInflater.from(context).inflate(R.layout.toolbar_uitls, null, false);
    ...
    public void setTitleBarWithBack(String title){
        setTitleBar(title,null,null,R.drawable.arrow_left,NO_RES_ID);
    }
     ...
     * @param listener
     */
    public void setCenterOnClickListener(OnClickListener listener) {

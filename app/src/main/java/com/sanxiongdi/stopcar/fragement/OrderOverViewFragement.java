...
import com.sanxiongdi.stopcar.adapter.OverRecyclerAdapter;
...
public class OrderOverViewFragement extends BaseFrament {
    ...
    private OverRecyclerAdapter overRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
          view = inflater.inflate(R.layout.order_over_view, container, false);
        init_View(inflater);
        return  view;
    }
    ...
    protected void init_View(LayoutInflater inflater) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.over_recycler_view);
        layout_swipe_refresh = (SwipeRefreshLayout) view.findViewById(R.id.layout_over_swipe_refresh);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        overRecyclerAdapter = new OverRecyclerAdapter(mData, mContext, inflater);
        mRecyclerView.setAdapter(overRecyclerAdapter);
        ...
        layout_swipe_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                overRecyclerAdapter.notifyDataSetChanged();
